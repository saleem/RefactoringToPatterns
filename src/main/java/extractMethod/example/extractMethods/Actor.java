package extractMethod.example.extractMethods;

import static extractMethod.example.extractMethods.Actor.Status.Alive;
import static extractMethod.example.extractMethods.Actor.Status.Dead;
