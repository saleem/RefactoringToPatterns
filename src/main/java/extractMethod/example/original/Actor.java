package extractMethod.example.original;

import static extractMethod.example.original.Actor.Status.Alive;
import static extractMethod.example.original.Actor.Status.Dead;
